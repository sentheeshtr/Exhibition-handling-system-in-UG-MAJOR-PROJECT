...
<body>
  ...
  <div id="content">
   <img src="images\1.jpg" width="1420" height="400">               
						...
						<h2 align="center">Booked Stalls</h2>
	...
	<td align="center"><strong>Satll name</strong></td>
	...
	<tr>
	<?php
	$qry=mysql_query("select * from book where status='1'");
	...
	<td align="center"><?php echo"Amount Paid";?></td>
